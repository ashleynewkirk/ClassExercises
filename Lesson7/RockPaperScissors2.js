...
var player1 = {  // creating player data as an object makes it easier to access info 
    name : prompt('enter first player name'),
    getHand : getHand,
    hand: null, // no value assigned...yet
    score: 0,
}
var player2 = {
    name : prompt('enter second player name'),
    getHand : getHand,
    hand: null,
    score: 0,
}
...
playGame(player1, player2, hand, winCondition, 5);
    if(player1.score>player2.score){
        ...
        var winnerresult = (`${player1.name}, with a score of ${player1.score} is the RPS Champion!!!`);
      
    }else{
    console.log(`${player2.name}, with a score of ${player2.score} is the RPS Champion!!!`);
   var winnerresult = (`${player2.name}, with a score of ${player2.score} is the RPS Champion!!!`);
...
function printOnScreen () {
    var myelement = document.getElementById("winner");
    // console.log(winnerresult);
    document.body.innerHTML = winnerresult;
}
printOnScreen(); 
